...
namespace Project_TARDIS
{
    ...
    public class Universe
    {
        ...
        private int GetNextWeaponID()
        {
            ...
            {
                if (weapon.GameObjectID > MaxID)
                {
                    MaxID = weapon.GameObjectID;
                }
            }
        ...
        private void IntializeUniverseWeapons()
        {
            Weapons.Add(new Weapon
            {
                Name = "Steel Sword",
                WeaponType = Weapons.GetType.Sword,
                GameObjectID = 1,
                Description = "A beautiful steel sword engraved with Norse Runes.",
                SpaceTimeLocationID = 2,
                HasValue = true,
                Value = 200,
                CanAddToInventory = true
